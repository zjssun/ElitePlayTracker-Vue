...
// 2026, 1, 31, 23, 59, 59 
const NOTICE_START_AT = new Date(2026, 7, 2, 0, 0, 0)
const NOTICE_END_AT = new Date(2026, 7, 14, 23, 59, 59)
...
<template>
  <div v-if="showNotice" class="notice-container">
    <div class="notice-content">
      ...
      <p>可以访问新域名:</p>
      <p class="notice-link"><a class="notice-link" href="https://eptracker.xyz">https://eptracker.de</a></p>
      <p>🗑️本域名将在⏱️2025年7月15日下线🔜</p>
